...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HaxeJam2023-Winter", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HaxeJam2023-Winter", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "HaxeJam2023-Winter";
		app.meta["name"] = "HaxeJam2023-Winter";
